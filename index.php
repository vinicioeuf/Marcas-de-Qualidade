      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-features owl-carousel" style="position: relative; z-index: 5;">
            <div class="item">
              <div class="thumb">
                <img src="assets/3/agir.jpg" alt="">
                <div class="hover-effect">
                  <div class="content">
                    <h4>Agir - empresa <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <span>(4.5)</span></h4>
                    <ul>
            ...
            <div class="item">
              <div class="thumb">
                <img src="assets/3/angelus3.jpg" alt="">
                <div class="hover-effect">
                  <div class="content">
                    <h4>Angelus - Empresa <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <span>(4.5)</span></h4>
                    <ul>
                      <div class="main-button">
                        <a href="">Ver</a>
                      </div>
            ...
            <div class="item">
              <div class="thumb ">
                <img src="assets/3/bio2.png" alt="">
                <div class="hover-effect">
                  <div class="content">
                    <h4>Bio Art - Empresa <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i> <span>(4.5)</span></h4>
                    <ul>
                      <div class="main-button">
                        <a href="">Ver</a>
                      </div>
            ...
            <!-- <div class="item">
              <div class="thumb">
                <img src="assets/3/featured-01.jpg" alt="">
                <div class="hover-effect">
                  <div class="content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="assets/3/featured-02.jpg" alt="">
                <div class="hover-effect">
                  <div class="content">
            ...
            <div class="item">
              <div class="thumb">
                <img src="assets/3/featured-03.jpg" alt="">
                <div class="hover-effect">
                  <div class="content">
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="section-heading">
            <h6>Outras empresas</h6>
            <h4>Ver todas as <em>empresas</em></h4>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="main-button">
            <a href="categories.html">Tudo</a>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            <div class="top-content">
              ...
              <div class="right">
                <h4>DX - Garantia de qualidade</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            <div class="top-content">
              <div class="icon">
                <img src="assets/3/fami2.png" alt="">
              </div>
              <div class="right">
                <h4>Fami - Tecnologia médica</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            <div class="top-content">
              <div class="icon">
                <img src="assets/3/fenix2.gif" alt="">
              </div>
              <div class="right">
                <h4>Fenix Dental</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            <div class="top-content">
              <div class="icon">
                <img src="assets/3/melhor2.png" alt="">
              </div>
              <div class="right">
                <h4>Melhor med</h4>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            <div class="top-content">
              <div class="icon">
                <img src="assets/3/prima2.png" alt="">
              </div>
              <div class="right">
                <h4>Prima Dental</h4>
              </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            <div class="top-content">
              <div class="icon">
                <img src="assets/3/rd2.png" alt="">
              </div>
              <div class="right">
                <h4>RD reliance dental</h4>
